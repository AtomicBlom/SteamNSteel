...
//I've modified it for performance and to reduce the surface of borrowed code.
//-- Steven
...
public class MatrixTransformation extends TransformationBase<MatrixTransformation> implements Copyable<MatrixTransformation>
{
    //m<row><column>
    public double m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33;

    public static MatrixTransformation getIdentity() {
    ...
    public MatrixTransformation(double d00, double d01, double d02, double d03,
    ...
    public MatrixTransformation(MatrixTransformation mat)
    {
        set(mat);
    }

    public MatrixTransformation setIdentity()
    {
        m00 = m11 = m22 = m33 = 1;
    ...
    public MatrixTransformation translate(Vertex vec)
    {
    ...
    public MatrixTransformation scale(Vertex vec)
    {
        m00 *= vec.x;
        m10 *= vec.x;
        m20 *= vec.x;
    ...
    public MatrixTransformation scale(double x, double y, double z)
    {
        m00 *= x;
        m10 *= x;
        m20 *= x;
    ...
    public MatrixTransformation rotate(double angle, Vertex axis)
    {
    ...
    public MatrixTransformation rotate(double angle, double x, double y, double z)
    {
        double c = Math.cos(angle);
        double s = Math.sin(angle);
        double mc = 1.0f - c;
    ...
    public MatrixTransformation leftMultiply(MatrixTransformation mat)
    {
    ...
    public MatrixTransformation multiply(MatrixTransformation mat)
    {
    ...
    public MatrixTransformation transpose()
    {
        double n00 = m00;
        double n10 = m01;
        double n20 = m02;
    ...
    public MatrixTransformation copy()
    {
        return new MatrixTransformation(this);
    }

    public MatrixTransformation set(MatrixTransformation mat)
    {
        m00 = mat.m00;
        m01 = mat.m01;
        m02 = mat.m02;
    ...
    public void apply(MatrixTransformation mat)
    {
        mat.multiply(this);
    }
    ...
    public void applyTo(MatrixTransformation nodeMatrix) {
        nodeMatrix.leftMultiply(this);
    }

    @Override
    protected void setValueInternal(ColladaSampler sampler, MatrixTransformation o) {
